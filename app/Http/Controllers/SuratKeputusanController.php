...
class SuratKeputusanController extends Controller
{
    ...
    public function cetak_surat_keputusan($kode_hasil)
    {
        ...
        $pdf = new Fpdf();
        $pdf->AddPage("P", "A4");
        $pdf->Image("images/logo_pajar.png", 11, 5, 31, 31);
        $pdf->Cell(30);
        $pdf->SetTextColor(0, 122, 55);
        $pdf->SetFont("Times", "B", "16");
        $pdf->Cell(0, 6, "YAYASAN PENDIDIKAN KI HAJAR DEWANTORO", 0, 1, "C");
        $pdf->Cell(30);
        $pdf->SetTextColor(0, 90, 158);
        $pdf->SetFont("Times", "B", "16");
        $pdf->Cell(0, 6, "SMP  KI HAJAR DEWANTORO", 0, 1, "C");
        $pdf->SetTextColor(97, 42, 138);
        $pdf->Cell(30);
        ...
        $pdf->Cell(
            0,
            6,
            "Jln. KH. Hasyim Ashari Km.9 Pinang Kota Tangerang NPSN. 20606689 Telp. 021.70276588",
            0,
            1,
            "C"
        );
        $pdf->Cell(25);
        $pdf->Cell(0, 5, "NOTARIS : YULITA ROESTAM, SH. Tangerang No.12", 0, 1, "C");
        $pdf->Cell(0, 5, "                   Provinsi BANTEN", 0, 1, "C");
        ...
        $pdf->Cell(329, 60, "Wahidin, S.Pd, M. M               ", 0, 1, "C");
        $pdf->SetFont("Times", "", "12");
        $pdf->Cell(327, -50, "NIP:7743761662200012         ", 0, 1, "C");
    ...
    public function cetak_laporan_sk(Request $request)
    {
        ...
        foreach ($sk as $s) {
            ...
            $pdf->Cell(30, 9, $s->nilai_saw, 1, 1, "C");
        }
